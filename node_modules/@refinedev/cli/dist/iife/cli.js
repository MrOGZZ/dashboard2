#!/usr/bin/env node
(()=>{var pn=Object.create;var ke=Object.defineProperty;var mn=Object.getOwnPropertyDescriptor;var un=Object.getOwnPropertyNames;var fn=Object.getPrototypeOf,gn=Object.prototype.hasOwnProperty;var i=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,r)=>(typeof require<"u"?require:t)[r]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw new Error('Dynamic require of "'+e+'" is not supported')});var rt=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),hn=(e,t)=>{for(var r in t)ke(e,r,{get:t[r],enumerable:!0})},vn=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of un(t))!gn.call(e,o)&&o!==r&&ke(e,o,{get:()=>t[o],enumerable:!(n=mn(t,o))||n.enumerable});return e};var p=(e,t,r)=>(r=e!=null?pn(fn(e)):{},vn(t||!e||!e.__esModule?ke(r,"default",{value:e,enumerable:!0}):r,e));var ye=rt((ps,zt)=>{"use client";var qn=Object.create,ve=Object.defineProperty,Mn=Object.getOwnPropertyDescriptor,Bn=Object.getOwnPropertyNames,Hn=Object.getPrototypeOf,zn=Object.prototype.hasOwnProperty,Wn=(e,t)=>{for(var r in t)ve(e,r,{get:t[r],enumerable:!0})},Ut=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Bn(t))!zn.call(e,o)&&o!==r&&ve(e,o,{get:()=>t[o],enumerable:!(n=Mn(t,o))||n.enumerable});return e},Jn=(e,t,r)=>(r=e!=null?qn(Hn(e)):{},Ut(t||!e||!e.__esModule?ve(r,"default",{value:e,enumerable:!0}):r,e)),Yn=e=>Ut(ve({},"__esModule",{value:!0}),e),Ft={};Wn(Ft,{DevToolsContext:()=>Ht,DevToolsContextProvider:()=>Xn,DevtoolsEvent:()=>Vt,hooksByScope:()=>Gn,receive:()=>Bt,scopes:()=>qt,send:()=>Mt});zt.exports=Yn(Ft);var Vt=(e=>(e.RELOAD="devtools:reload",e.DEVTOOLS_INIT="devtools:init",e.DEVTOOLS_HANDSHAKE="devtools:handshake",e.DEVTOOLS_ALREADY_CONNECTED="devtools:already-connected",e.ACTIVITY="devtools:send-activity",e.DEVTOOLS_ACTIVITY_UPDATE="devtools:activity-update",e.DEVTOOLS_CONNECTED_APP="devtools:connected-app",e.DEVTOOLS_DISCONNECTED_APP="devtools:disconnected-app",e.DEVTOOLS_HIGHLIGHT_IN_MONITOR="devtools:highlight-in-monitor",e.DEVTOOLS_HIGHLIGHT_IN_MONITOR_ACTION="devtools:highlight-in-monitor-action",e.DEVTOOLS_LOGIN_SUCCESS="devtools:login-success",e.DEVTOOLS_RELOAD_AFTER_LOGIN="devtools:reload-after-login",e))(Vt||{}),qt={useCan:"access-control",useLog:"audit-log",useLogList:"audit-log",useCreate:"data",useCreateMany:"data",useCustom:"data",useCustomMutation:"data",useDelete:"data",useDeleteMany:"data",useInfiniteList:"data",useList:"data",useMany:"data",useOne:"data",useUpdate:"data",useUpdateMany:"data",useForgotPassword:"auth",useGetIdentity:"auth",useIsAuthenticated:"auth",useLogin:"auth",useLogout:"auth",useOnError:"auth",usePermissions:"auth",useRegister:"auth",useUpdatePassword:"auth"},Gn=Object.entries(qt).reduce((e,[t,r])=>(e[r]||(e[r]=[]),e[r].push(t),e),{}),K=Jn(i("react"));async function Mt(e,t,r){if(e.readyState!==e.OPEN){await new Promise(n=>{let o=()=>{e.send(JSON.stringify({event:t,payload:r})),n(),e.removeEventListener("open",o)};e.addEventListener("open",o)});return}else{e.send(JSON.stringify({event:t,payload:r}));return}}function Bt(e,t,r){let n=o=>{let{event:a,payload:c}=JSON.parse(o.data);t===a&&r(c)};return e.addEventListener("message",n),()=>{e.removeEventListener("message",n)}}var Ht=K.default.createContext({__devtools:!1,port:5002,url:"localhost",secure:!1,ws:null}),Xn=({__devtools:e,port:t,children:r})=>{let[n,o]=K.default.useState({__devtools:e??!1,port:t??5002,url:"localhost",secure:!1,ws:null}),[a,c]=K.default.useState(null);K.default.useEffect(()=>{let d=new WebSocket(`${n.secure?"wss":"ws"}://localhost:${n.port}`),l=Bt(d,"devtools:handshake",u=>{o(y=>({...y,devtoolsUrl:u.url})),l()});return d.addEventListener("open",()=>{n.__devtools||Mt(d,"devtools:init",{url:window.location.origin})}),c(d),()=>{l(),d.close(1e3,window.location.origin)}},[]);let s=K.default.useMemo(()=>({...n,ws:a}),[n,a]);return K.default.createElement(Ht.Provider,{value:s},r)}});var nr=rt((gs,rr)=>{var Kn=Object.create,Ee=Object.defineProperty,Qn=Object.getOwnPropertyDescriptor,Zn=Object.getOwnPropertyNames,eo=Object.getPrototypeOf,to=Object.prototype.hasOwnProperty,ro=(e,t)=>{for(var r in t)Ee(e,r,{get:t[r],enumerable:!0})},Xt=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Zn(t))!to.call(e,o)&&o!==r&&Ee(e,o,{get:()=>t[o],enumerable:!(n=Qn(t,o))||n.enumerable});return e},v=(e,t,r)=>(r=e!=null?Kn(eo(e)):{},Xt(t||!e||!e.__esModule?Ee(r,"default",{value:e,enumerable:!0}):r,e)),no=e=>Xt(Ee({},"__esModule",{value:!0}),e),Kt={};ro(Kt,{server:()=>ia});rr.exports=no(Kt);var oo=v(i("express")),w=ye(),ao=v(i("express")),Wt=v(i("path")),io=e=>{e.use(ao.default.static(Wt.default.join(__dirname,"client"))),e.use((t,r,n)=>{if(t.path.startsWith("/api")||t.path.startsWith("/open-in-editor"))return n();r.status(200).sendFile(Wt.default.join(__dirname+"/client/index.html"))})},so=v(i("ws")),Le="https://cloud2.refine.dev",co="https://raw.githubusercontent.com/refinedev/refine/master/packages/devtools-server/FEED.md",Jt=ye(),we=i("chalk"),lo=()=>{let e=new so.default.Server({port:5002}).on("error",t=>{(t==null?void 0:t.code)==="EADDRINUSE"?console.error(`
...
`):console.error(`
${we.cyanBright.bold("\u2717 ")}${(0,we.bold)("error from refine devtools")}`,t),process.exit(1)});return e.on("connection",t=>{(0,Jt.send)(t,Jt.DevtoolsEvent.DEVTOOLS_HANDSHAKE,{url:"http://localhost:5001"}),t.on("close",()=>{t.terminate()})}),process.on("SIGTERM",()=>{e.close(()=>{})}),e},ms=i("lodash"),us=ye(),fs=i("ws"),po=()=>0,H=i("chalk"),mo=e=>{let t=e.listen(5001,()=>{}).on("error",r=>{(r==null?void 0:r.code)==="EADDRINUSE"?console.error(`
${H.cyanBright.bold("\u2717 ")}${(0,H.bold)("refine devtools")} failed to start. Port 5001 is already in use, please make sure no other devtools server is running
`):console.error(`
${H.cyanBright.bold("\u2717 ")}${(0,H.bold)("error from refine devtools")}`,r),process.exit(1)}).on("listening",()=>{console.log(`
${H.cyanBright.bold("\u2713 ")}${(0,H.bold)("refine devtools")} is running at port ${H.cyanBright.bold(5001)}
`)});process.on("SIGTERM",()=>{t.close(()=>{})})},uo={connectedApp:null,clientWs:null,devtoolsWsClients:[],appWsClients:[],activities:[],packages:[]},fo=()=>({...uo}),go=i("express"),ho=v(i("lodash/uniq")),vo=v(i("node-fetch")),yo=v(i("gray-matter")),je=i("marked"),$e=v(i("sanitize-html")),wo=e=>e.split("---section").slice(1).map(t=>`---section${t}`),Po=e=>{let t=new je.marked.Renderer;t.link=function(...n){return je.marked.Renderer.prototype.link.apply(this,n).replace(/^<a/,'<a target="_blank" rel="noopener noreferrer"')};let r=(0,je.marked)(e,{renderer:t});return(0,$e.default)(r,{allowedTags:$e.default.defaults.allowedTags.concat(["img"]),allowedAttributes:{...$e.default.defaults.allowedAttributes,img:["src"]}})},Eo=e=>{let t=(0,yo.default)(e.replace("---section","---"));return{...t.data,content:Po(t.content)}},xo=async()=>{try{return(await(0,vo.default)(co)).text()}catch{return""}},Ro=async()=>{try{let e=await xo();return wo(e).map(Eo)}catch{return[]}},Io=v(i("fs")),bo=v(i("path")),Oo=v(i("globby")),Co=async e=>{try{let t=await(0,Oo.default)(`node_modules/${e}/package.json`,{onlyFiles:!0}),r=null;try{let n=i.resolve(bo.default.join(e,"package.json"));n&&(r=n)}catch{}return[...t,...r?[r]:[]][0]??null}catch{return null}},To=async e=>{try{let t=await Co(e);if(!t)return null;let r=JSON.parse(Io.default.readFileSync(t,{encoding:"utf-8"}));return{name:r.name,version:r.version,description:r.description}}catch{return null}},So=v(i("path")),ko=i("fs-extra"),Qt=async(e=process.cwd())=>{let t=await(0,ko.readJSON)(So.default.join(e,"package.json"),{encoding:"utf-8"});return Object.keys(t.dependencies).filter(r=>r.startsWith("@refinedev/"))},Ao=e=>e.replace("@refinedev/","https://c.refine.dev/"),_o=e=>"https://refine.dev/docs/api-reference/general-concepts/",No=async e=>{try{let t=await Qt(e);return await Promise.all(t.map(async r=>{let n=await To(r);return{name:r,currentVersion:n==null?void 0:n.version,description:n==null?void 0:n.description,changelog:Ao(r),documentation:_o(r)}}))}catch{return[]}},P=v(i("dedent")),Do=[{name:"@refinedev/ably",description:"Ably integration for refine",install:"npm install @refinedev/ably",usage:(0,P.default)(`
